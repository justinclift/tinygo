...
LLVM_DIR ?= /opt/llvm8-wasm
LLVM_BUILDDIR ?= /home/jc/local/build8-wasm
...
CGO_LDFLAGS=-L$(LLVM_BUILDDIR)/lib $(CLANG_LIBS) $(LLD_LIBS) $(shell $(LLVM_DIR)/bin/llvm-config --ldflags --libs --system-libs $(LLVM_COMPONENTS))
